...
module MakeMap(Map : MapArgument) = struct
  ...
  and map_extension_default edef =
    ...
    let edef_case = map_case edef.edef_case in
    Map.leave_extension_default {edef with edef_case = edef_case}
  ...
  and map_pattern pat =
    ...
    let pat_desc =
      match pat.pat_desc with
        ...
        | Tpat_construct (lid, cstr_decl, total, args) ->
          Tpat_construct (lid, cstr_decl, total,
